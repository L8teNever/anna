...
(function (root) {
  const GAMES = [
    ...
    {
      id: "reaktion",
      name: "Reaktionsspiele",
      tag: "Geschick",
      description: "Reflextest und Zeitgefühl – wer hat die schnellsten Finger?",
      detail: "Eine wachsende Sammlung kleiner Reaktions- und Präzisionsspiele. Untergame aus der Übersicht wählen und direkt loslegen.",
      icon: "stopwatch",
      color: "green",
      minPlayers: 1,
      maxPlayers: 20,
      assets: [
        "/games/reaktion/reaktion.js",
        "/games/reaktion/reaktion.css",
        "/games/reaktion/reflex.js",
        "/games/reaktion/reflex.css",
        "/games/reaktion/stopuhr.js",
        "/games/reaktion/stopuhr.css",
      ],
    },
    {
